 ...
 * this namespace add properties. See
 * alcamo::dom::extended::RegisteredNodeTrait for an explanation why and how
 * these properties need to be conserved.
 *
 ...
 * DOMNode, except the classes derived from DOMDocument.
 *
 * Cloning a document with PHP's `clone` mechanism may be useful instead
 * because PHP then creates a deep clone of the underlying DOM tree, hence
 * __clone() methods are indeed defined on document level.
 */
